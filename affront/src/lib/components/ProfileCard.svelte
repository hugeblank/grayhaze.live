...
<div class="min-w-96 md:m-8 md:w-auto p-4 bg-local border-gray-500 rounded-lg my-2" style="background-image: url({extractImage(validator.banner.value)}); background-size: cover; background-position: center;">
